...
class Quiz:
    ...
    def display_question(self):
        ...
        q_no = Label(gui, text= question[self.q_no], font=('ariel', 16, 'bold'), anchor='w')
    ...
    def display_title(self):
        ...
        title = Label(gui, text="Kon Bane Ga Entrepreneur - Quiz Program for NAVTCC Bacthes with Qs",
                       bg="green", fg="white", font=("ariel", 20, "bold"))

        # place of the title
        title.place(x=220, y=2)
...
gui.geometry("1600x750")

# set the title of the Window
gui.title("Kon Bane Ga Entrepreneur Quiz")
